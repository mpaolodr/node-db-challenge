...
- [x] Explain the difference between `Relational Databases` and `SQL`.
  ...
  - Relational Databases, or Databases in general, is where we store our data.
  - SQL is the language we use to communicate with our databases and used to manipulae data in the database

- [x] Why do tables need a `primary key`?

  - because they are used to identify entries and important for connecting tables via foreign keys
